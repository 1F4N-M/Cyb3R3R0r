...
def siapa():
	...
	if nama =="":
		...
		os.system('clear')
		jalan("\033[1;97mSelamat datang \033[1;92m" +nama+ "\n\033[1;91mThank you Have Been Using This Tools ..tong di salah gunakeun..[•]subscribe chanel abang gua..") 
                time.sleep(1)
		loginSC()
...
def loginSC():
	os.system('clear')
	jalan("\033[1;93mSilahkan login SC nya dulu....jangan di salah gunakan && di perjual belikan...If the username and fasswordnya don't know please ask the maker on the script ..! \n")
...
def menu():
	...
	print "\n\x1b[1;91m0.\x1b[1;91m logout sayang😘            "
	pilih()
